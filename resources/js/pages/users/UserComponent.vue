            ...
            <form novalidate class="md-layout" @submit.prevent="validateUser()">
                <md-card>
                    ...
                    <md-card-content>
                        <md-content class="md-scrollbar">
                                ...
                                <div class="md-layout">
                                    ...
                                    <div class="md-layout-item md-small-size-100 md-size-33" v-if="zones && zones.length > 0">
                                        <md-field>
                                    ...
                                    <div class="md-layout-item md-small-size-100 md-size-33" v-if="communities && communities.length > 0">
                                        <md-field>
                    ...
                    <md-card-actions>
                        ...
                        <md-button type="submit" class="md-primary" :disabled="sending">Create member</md-button>
                    </md-card-actions>
                </md-card>
