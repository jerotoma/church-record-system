                ...
                <form novalidate class="md-layout" @submit.prevent="validateUser()">
                    <md-card>
                        <md-card-header  :data-background-color="dataBackgroundColor">
                            <div class="md-title">Add New Role</div>
                        ...
                        <md-card-actions>
                            ...
                            <md-button type="submit" class="md-primary" :disabled="isLoading">Create Role</md-button>
                        </md-card-actions>
                    </md-card>
                    <md-snackbar
                        md-position="center"
...
import { roleForm, roleRequiredFields } from './role-form-criteria';
import { mapGetters } from 'vuex';

export default {
    name: 'role-create-component',
    ...
    methods: {
        ...
        createRole () {
             this.$store.dispatch('postRole', this.form)
             .then((response) => {
                 this.clearForm();
             }).catch((error) => {
