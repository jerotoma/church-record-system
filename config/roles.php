...
return [
    ...
    */
    ...
    'models' => [
        'role'          => env('ROLES_DEFAULT_ROLE_MODEL', config('auth.providers.roles.model')),
        'permission'    => env('ROLES_DEFAULT_PERMISSION_MODEL', config('auth.providers.permissions.model')),
